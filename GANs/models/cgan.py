...
class Generator(nn.Module):
    ...
    def __init__(self, batch_size, image_size=128, z_dim=100, conv_dim=64, channels=1, n_classes=10):
        ...
        self.l1 = nn.Sequential(
            ...
            BayesianConv2d(self.z_dim, conv_dim * mult, (4,4)),
        ...
        self.l2 = nn.Sequential(
            BayesianConv2d(curr_dim, int(curr_dim / 2), (4,4)),
        ...
        self.last = nn.Sequential(
            BayesianConv2d(curr_dim, self.channels, (4,4)),
            nn.Tanh()
        )
...
class Discriminator(nn.Module):
    ...
    def __init__(self, batch_size, n_classes=10, image_size=128, conv_dim=64, channels=1):
